...
const ServiceTabs = (props) => {
    ...
    return (
        <div className={classes.root}>
            <Paper square>
                <Tabs value={value} variant="scrollable" scrollButtons="on" centered onChange={handleChange} aria-label="simple tabs example">
                    ...
                    <Grid container spacing={0}>
                        ...
                        <Grid item xs={12} sm={6} className="p-4">
                            <div className="tab-content px-5">
                                ...
                                <button className="btn-theme btn-explore" onClick={()=> window.location = "https://www.hresortseychelles.com/dining/"}>EXPLORE</button>
                            </div>
                        </Grid>
                    </Grid>
                </div>
                    ...
                    <Grid container spacing={0}>
                        ...
                        <Grid item xs={12} sm={6} className="p-4">
                            <div className="tab-content px-5">
                                ...
                                <button className="btn-theme btn-explore" onClick={()=> window.location = "https://www.hresortseychelles.com/spa-and-wellness/"}>EXPLORE</button>
                            </div>
                        </Grid>
                    </Grid>
                </div>
